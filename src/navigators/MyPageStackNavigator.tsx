...
import ToSandPoliciesScreen from '../screens/myPage/appInformationScreens/ToSandPoliciesScreen';
import PrivacyPoliciesScreen from '../screens/myPage/appInformationScreens/PrivacyPoliciesScreen';
...
const AppInformationStack = createStackNavigator<MyPageAppInformationStackParamList>();
...
const MyPageAppInformationStackNavigator = () => {
  return (
    <AppInformationStack.Navigator
      ...
      screenOptions={{headerShown: false}}>
      <AppInformationStack.Screen name="Mypage_appInformation" component={MypageAppInformationScreen} />
      <AppInformationStack.Screen name="Mypage_ToSandPolicies" component={ToSandPoliciesScreen} />
      <AppInformationStack.Screen name="Mypage_privacyPolicies" component={PrivacyPoliciesScreen} />
      <AppInformationStack.Screen name="Mypage_advertisingandMarketingConsent" component={AdvertisingandMarketingConsentScreen} />
    </AppInformationStack.Navigator>
  );
};
