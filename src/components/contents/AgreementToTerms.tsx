...
const AgreementToTerms = ({
  ...
  const CheckCircleCheckedImage = () => (
    <Image source={require('../../assets/images/check_circle_checked.png')} />
  );
  const CheckCircleUncheckedImage = () => (
    <Image source={require('../../assets/images/check_circle_unchecked.png')} />
  );
  ...
  const toggleAll = () => {
    ...
    } else setChecked([true, true, true]);
  };
